...
class PalabrasSilabasService {
    constructor() {
        this.coleccion = 'Musica';
    ...
    async getPalabras() {
        try {
            ...
            console.log('error recuperando palabras silabas', error);
            throw error;
        }
    }
    ...
    async addPalabra(palabra) {
        try {
            ...
            console.log('error añadiendo palabra silaba', error);
            throw error;
        }
    }
...
module.exports = PalabrasSilabasService;
